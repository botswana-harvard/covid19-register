    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
                ('temperature', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='covid19_register.Temperature', verbose_name='Temperature')),
            ],
            options={
                'verbose_name': 'Covid-19 Register',
                'verbose_name_plural': 'Covid-19 Register',
