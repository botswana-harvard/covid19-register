# Generated by Django 3.1 on 2020-08-16 09:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female'), ('U', 'Undetermined')], max_length=1, null=True, verbose_name='Gender')),
                ('identity', django_crypto_fields.fields.identity_field.IdentityField(blank=True, help_text=' (Encryption: RSA local)', max_length=71, null=True, verbose_name='Identity number/Passport number')),
                ('cell', django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(blank=True, help_text=' (Encryption: RSA local)', max_length=71, unique=True, validators=[edc_base.model_validators.phone.CellNumber], verbose_name='Cell number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('today_date', models.DateField(verbose_name='Date')),
                ...
                ('site_name', models.CharField(choices=[('bhp_hq', 'BHP HQ'), ('mmabana', 'Mmabana'), ('tsepamo', 'Tsepamo'), ('PEPFAR', 'PEPFAR'), ('hr_finance', 'HR/Finance'), ('HPTN', 'HPTN'), ('ambition', 'Ambition'), ('CTU', 'CTU')], max_length=20, verbose_name='Site name')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.site')),
            ],
            options={
                'verbose_name': 'Covid-19 Register',
